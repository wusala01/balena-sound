...
| SOUND_SPOTIFY_DISABLE_CACHE | Disable the audio cache in Spotify which can take up larged amounts of disk space. | Disabled if the variable exists regardless of its value. | --- |
